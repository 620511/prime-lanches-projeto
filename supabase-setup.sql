...
insert into menu (id, cat, name, description, price, emoji, tag, available) values
  ...
  ('l1', 'Lanches', 'Prime Clássico', 'Brioche, blend 160g, queijo prato, alface, tomate e molho da casa', 24.9, '🍔', 'Mais pedido', true),
  ('l2', 'Lanches', 'Bacon Fire', 'Blend 160g, bacon crocante, cheddar e molho barbecue defumado', 28.9, '🔥', 'Picante', true),
  ('l3', 'Lanches', 'Duplo Smash', 'Dois blends smash 90g, queijo derretido e picles', 27.9, '🧀', null, true),
  ('l4', 'Lanches', 'Frango Crocante', 'Peito de frango empanado, maionese de ervas e alface americana', 23.9, '🍗', 'Novo', true),
  ('l5', 'Lanches', 'Veggie Prime', 'Hambúrguer de grão-de-bico, rúcula, tomate seco e maionese vegana', 25.9, '🥬', 'Veggie', true),
  ...
  ('s1', 'Sobremesas', 'Brownie com Sorvete', 'Brownie quente, sorvete de creme e calda de chocolate', 16.9, '🍫', null, true),
  ('s2', 'Sobremesas', 'Petit Gateau', 'Bolinho de chocolate com recheio cremoso e sorvete', 18.9, '🍰', 'Mais pedido', true)
